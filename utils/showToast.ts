...
export const showToastFrom = {
  ...
  info: {
    ...
    refreshingRecipes: () => showInfo({ messageKey: 'info.refreshingRecipes' }),
    filteringRecipes: () => showInfo({ messageKey: 'info.filteringRecipes' }),
    aiThinking: () => showInfo({ messageKey: 'info.aiThinking' }),
    aiAnalyzingImage: () => showInfo({ messageKey: 'info.aiAnalyzingImage' }),
    generatingRecommendations: () => showInfo({ messageKey: 'info.generatingRecommendations' }),
